...
func TestVLess0_udp(t *testing.T) {
	proxy.TestUDP("vless", 0, netLayer.RandPortStr_safe(true, true), 0, t)
}

func TestVLess1_udp(t *testing.T) {
	proxy.TestUDP("vless", 1, netLayer.RandPortStr_safe(true, true), 0, t)
}

func TestVLess1_udp_multi(t *testing.T) {
	proxy.TestUDP("vless", 1, netLayer.RandPortStr_safe(true, true), 1, t)
}
